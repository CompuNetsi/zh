...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.crossSize = 8; // px
		this.closeButton = true; // whether to display the Close button
		this.closeText = 'OK';
		...
		this.controlBorderColor = 'rgba(255,255,255,1)'; // CSS color
		...
		function drawPicker () {
			...
			p.btn.style.left =  '150px';
			p.btn.style.bottom = THIS.padding + 'px';
			p.btn.style.padding = '0 ' + btnPadding + 'px';
			p.btn.style.maxWidth = (pickerDims.contentW - 2 * THIS.controlBorderWidth - 2 * btnPadding) + 'px';
			p.btn.style.height = THIS.buttonHeight + 'px';
			p.btn.style.border = '2px solid ';

			setBtnBorder();
		p.btn.style.background = 'rgb(6 125 113)';
			p.btn.style.color = 'rgb(255 255 255)';
